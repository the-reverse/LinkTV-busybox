...
#define USE_FEATURE_BUFFERS_GO_IN_BSS(...)  __VA_ARGS__
...
#define CROSS_COMPILER_PREFIX "mipsel-linux-"
...
#define ENABLE_FEATURE_REEXEC_INIT 1
#define USE_FEATURE_REEXEC_INIT(...)  __VA_ARGS__
#define SKIP_FEATURE_REEXEC_INIT(...)
